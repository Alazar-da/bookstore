  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
        ...
        formData.append("PhoneNumber", data.PhoneNumber);
          ...
          const response = await fetch('/api/customerbook', {
            method: "post",
      ...
      <div className="lg:w-4/5 py-5 pt-5 grid grid-cols-7">
          <form onSubmit={handleSubmit} className=" flex flex-col gap-3 border p-4 border-slate-600 rounded-lg col-span-4 col-start-3 bg-slate-500">
              ...
              <div className="grid justify-center">
                  ...
                  required
                  type="Number" name="PhoneNumber" placeholder="PhoneNumber" className="input input-bordered input-primary w-full max-w-xs bg-white" />
              </div>
              <div className="grid justify-center">
